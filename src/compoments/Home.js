                ...
                <header>
                    <div className="d-flex p-3 p-md-10">
                        <div className="dichvu">
                            <div className="logo">
                                {user && user.uath === true ? <img id="nen" src={nen} alt="" /> : <i class="fa-solid fa-user-plus"></i>}
                                {user && user.uath === true && <i onClick={handleAvata} className="fa-regular fa-pen-to-square"></i>}
                            </div>
                        </div>
                        <div className="wel">
                            <h2>Welcome</h2>
                    ...
                    {avata && <div className="avata">
                        <i onClick={() => setavata()} class="fa-regular fa-circle-xmark"></i>
                        <label htmlFor="image"><i class="fa-solid fa-user-plus"></i></label>
                        <input type="file" hidden id="image" value="" name="images" onChange={(e) => setimage(e.target.value)} />
                        {user && user.uath === true && <span>{user.name}</span>}
                    </div>
                    }

                </header>
                <main className="main rounded">
                    <h3 className="text-center"><strong>Our Services</strong></h3>
                    <div className="d-flex p-3 p-md-10 justify-content-center">
                        <Carousel>
                            <Carousel.Item>
                    ...
                    <h3 className="text-center"><strong>choose One</strong></h3>
                    <div className="mt-5" >
                        <Container>
                            <Row>
                                <Col>
                                    <div className="dichvu">
                                        <div className=" p-3 ">
                                            <img src={keo} alt="" />
                                            <h3 onClick={() => handleCutting()}><strong>Cutting</strong></h3>
                                        </div>
                                    </div>
                                </Col>
                                <Col>
                                    <div className="dichvu">
                                        <div className=" p-3">
                                            <img src={dao} alt="" className="img-fluid" />
                                            <h3 onClick={() => handleSevices()}><strong>Shaving</strong></h3>
                                        </div>
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                                <Col>
                                    <div className="dichvu ">
                                        <div className="p-3">
                                            <img src={dau} alt="" />
                                            <h3 onClick={() => handleFacial()}><strong>Facial</strong></h3>
                                        </div>
                                    </div>
                                </Col>
                                <Col>
                    ...
                    <div className="dichvu">
                        <div className="card">
                            ...
                            {user && user.uath === true ?
                                <div className="p-3">
                                    <div className="img">
                                        <img id='nen' src={user.avatas.nen} alt="" />
                                    </div>
                                    <span>{user.name}</span>
                                </div> :
                                <div className="p-3">
